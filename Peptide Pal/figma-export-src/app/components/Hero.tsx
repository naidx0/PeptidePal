...
const heroImage = "https://images.unsplash.com/photo-1747240901113-0a8496fd1b0f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbGVhbiUyMG1pbmltYWxpc3QlMjBzY2llbmNlJTIwbGFiJTIwYWVzdGhldGljfGVufDF8fHx8MTc3MTY0NzcwOHww&ixlib=rb-4.1.0&q=80&w=1920";

export function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-100px)] bg-[#Fdfcf8] text-black pt-32 lg:pt-24 border-b border-black">
      
      {/* Top Banner Marquee within Hero section */}
        ...
        <div className="flex flex-col justify-center px-6 lg:px-16 py-12 lg:py-24 border-r-0 lg:border-r border-black bg-[#Fdfcf8]">
          ...
          >
            ...
            <p className="text-sm md:text-base font-medium text-gray-500 max-w-sm leading-relaxed tracking-wide">
              High-performance peptide solutions for the modern human. 
              Clean ingredients. Clinical efficacy. No compromise.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <button className="px-8 py-4 bg-black text-white text-xs font-bold uppercase tracking-widest hover:bg-gray-800 transition-all flex items-center justify-center gap-2 group border border-black">
                Shop Protocols
                <ArrowUpRight className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
              </button>
              <button className="px-8 py-4 bg-transparent text-black text-xs font-bold uppercase tracking-widest hover:bg-black hover:text-white transition-all border border-black flex items-center justify-center">
                Learn More
              </button>
            </div>
          </motion.div>
