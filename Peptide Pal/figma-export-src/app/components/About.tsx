...
const aboutImage = "https://images.unsplash.com/photo-1767801035070-f7562a50b8e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvcmdhbmljJTIwc2hhcGVzJTIwYmVpZ2UlMjBiYWNrZ3JvdW5kfGVufDF8fHx8MTc3MTY0NzcwOXww&ixlib=rb-4.1.0&q=80&w=1080";

export function About() {
  const benefits = [
    { title: "Cellular Repair", icon: FlaskConical, desc: "Accelerate tissue regeneration at the molecular level." },
    { title: "Cognitive Boost", icon: Zap, desc: "Enhance focus, memory, and mental clarity." },
    { title: "Peak Performance", icon: Activity, desc: "Maximize athletic output and recovery speed." },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 border-b border-black">
           <div className="p-8 lg:p-16 border-r border-black flex flex-col justify-between">
              <div>
                ...
                <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-8">
                  Optimization <br/> Built on <br/> <span className="font-serif italic lowercase font-light text-gray-400">Bio-Chemistry</span>
                </h2>
              </div>
              
              <div className="mt-8">
                 <p className="text-sm md:text-base font-medium leading-relaxed max-w-md text-gray-600">
                   We are a team of scientists, doctors, and biohackers focused on pushing the boundaries of human potential.
                   From peptide synthesis to personalized protocol design, we help high-performers unlock their biological ceiling.
                 </p>
                 <button className="mt-8 px-6 py-3 border border-black hover:bg-black hover:text-white transition-all text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                    Meet The Experts
           ...
           <div className="relative h-[50vh] lg:h-auto border-t lg:border-t-0 border-black overflow-hidden bg-gray-100">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                 <span className="text-[12rem] font-black text-black/5 rotate-90 lg:rotate-0 select-none">
                    DNA
                 </span>
              </div>
           </div>
