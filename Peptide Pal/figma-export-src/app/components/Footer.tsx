    ...
    <footer className="bg-[#Fdfcf8] text-black border-t border-black">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-black">
        ...
        <div className="p-12 flex flex-col gap-6">
          ...
          <a href="#" className="text-sm font-bold uppercase hover:underline">Peptides</a>
          <a href="#" className="text-sm font-bold uppercase hover:underline">Protocols</a>
          <a href="#" className="text-sm font-bold uppercase hover:underline">Bundles</a>
          <a href="#" className="text-sm font-bold uppercase hover:underline">New Arrivals</a>
        </div>

        {/* Links 2 */}
        <div className="p-12 flex flex-col gap-6">
          <h4 className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-4">Support</h4>
          <a href="#" className="text-sm font-bold uppercase hover:underline">FAQ</a>
          <a href="#" className="text-sm font-bold uppercase hover:underline">Contact</a>
          <a href="#" className="text-sm font-bold uppercase hover:underline">Shipping</a>
          <a href="#" className="text-sm font-bold uppercase hover:underline">Returns</a>
        </div>
